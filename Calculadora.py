...
Fr2 = Frame(Fr1, bd=15, pady=2, width=600, height=300, bg="#1d3763", relief=RIDGE)
Fr2.grid()

Fr3 = Frame(Fr1, bd=10, pady=2, width=600, height=300, bg="#1d3763", relief=RIDGE)
Fr3.grid()

Fr4 = Frame(Fr2, bd=10, pady=2, width=590, height=50, bg="#1d3763", relief=SUNKEN)
...
Fr5 = Frame(Fr2, bd=2, pady=2, width=590, height=50, bg="#1d3763", relief=RIDGE)
